"""
Identical transformation SQL to Parts 2, 3 & 4 — kept as a copy so each part
folder is a self-contained, deployable function app. Only the orchestration
and error handling differ between parts.
"""
...
# --- COMPENSATION ----------------------------------------------------------
# Undo partial work after an unrecoverable failure (saga rollback).
COMPENSATE = """
TRUNCATE TABLE staging.customer_orders_joined;
"""
